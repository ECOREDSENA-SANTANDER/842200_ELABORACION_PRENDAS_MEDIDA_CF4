export default {
  global: {
    ...
    descripcionCurso:
      'En este componente formativo se abordan las temáticas de levantamiento de patrones base, básicos de patronaje femenino y desarrollos de moldería.<br><br>En la elaboración de moldes básicos desde el componente anatómico se logra interpretar diseños a partir de la transformación de los patrones base. Se desarrollará la sinergia entre cuerpo, patrón y diseño en la que convergen factores de análisis, interpretación, precisión, adaptación y transformación según el material textil, la intencionalidad de uso y otros elementos como insumos y avíos. En concordancia, se vivenciarán desafíos con el objetivo de efectuar la experimentación de la forma y la silueta.',

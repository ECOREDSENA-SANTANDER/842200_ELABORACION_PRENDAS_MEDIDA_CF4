...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .titulo-segundo
      #t_2_3.h2 2.3 Piezas complementarias
          ...
          .col-lg-10.mt-5
            ul.lista-ul--color
              li 
                ...
                .h3.txt_top Los botones y ojales
    ...
    TabsA.color-acento-contenido.mb-5
      .tarjeta.tarj_color.p-4(titulo="Extensión de delantero")
      ...
      .tarjeta.tarj_color.p-4(titulo="Montado de delanteros")
      ...
      .tarjeta.tarj_color.p-4(titulo="Falsos o vueltas")
      ...
      .tarjeta.tarj_color.p-4(titulo="Falsos continuos")
    ...
    TabsA.color-acento-contenido.mb-5
      ...
      .tarjeta.tarj_color.p-4(titulo="Extensión en frente")
        .row
          .col-lg-6
            figure
    ...
    .jumbo_1.p-4.mb-5
      .row.align-items-center
        ...
        .col-lg-4
          img(src="@/assets/curso/tema_2/img_15.png")

    .row.mb-3
      .col-lg-8
        p Para que conozca los básicos y las interpretaciones que se generan en una variación de nuevos patrones, en escala ¼ y con medidas de diferentes cuerpos explore siguiendo los esquemas que aparecen en el manual de patronaje básico e interpretación de diseños en las páginas 59 a la 62.
      .col-lg-4
